...
export const SAMPLE_LIBRARY: SampleEntry[] = [
  ...
  },
  {
    ...
    summary: "Steady 1D conduction bar with prescribed end temperature for quick temperature-gradient and heat-flux checks, and for projecting into Thermal Bar 1D.",
  },
  {
    ...
    summary: "1D conduction bar with restrained end temperatures and internal nodal heat source for benchmark-style source-to-flux checks.",
  },
  {
    ...
    summary: "Steady CST conduction patch for quick temperature-field and heat-flux checks, and for projecting into Thermal Plane Triangle 2D.",
  },
  {
    ...
    summary: "Triangulated heat strip with left-right prescribed temperatures for benchmark-style in-plane gradient and flux checks.",
  },
  {
    ...
    summary: "Single quad conduction patch for quick 2D temperature-gradient and heat-flux checks, and for projecting into Thermal Plane Quad 2D.",
  },
  {
    ...
    summary: "Two-quad conduction strip with prescribed end temperatures for benchmark-style directional heat-flow checks.",
  },
  {
    id: "thermal-bar-1d",
    name: "Thermal Bar 1D",
