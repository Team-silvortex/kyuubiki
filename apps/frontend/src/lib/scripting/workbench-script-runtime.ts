...
export const WORKBENCH_SCRIPT_ACTIONS: WorkbenchScriptActionDefinition[] = [
  ...
  },
  {
    ...
    category: "project",
    summary: {
      en: "Delete the selected project without UI confirmation.",
      zh: "删除当前选中项目，不经过界面确认。",
    },
  },
  {
    ...
    category: "project",
    summary: {
      en: "Download the selected project as JSON.",
      zh: "将当前项目导出为 JSON。",
    },
  },
  {
    ...
    category: "project",
    summary: {
      en: "Download the selected project as a .kyuubiki bundle.",
      zh: "将当前项目导出为 .kyuubiki 包。",
    },
  },
  {
  ...
  },
  {
    ...
    category: "model",
    summary: {
      en: "Delete the currently selected saved model.",
      zh: "删除当前选中的已保存模型。",
    },
  },
  {
  ...
  },
  {
    ...
    category: "model",
    summary: {
      en: "Delete the selected saved version.",
      zh: "删除当前选中的保存版本。",
    },
  },
  {
  ...
  },
  {
    ...
    category: "job",
    summary: {
      en: "Cancel the active running job.",
      zh: "取消当前运行中的任务。",
    },
  },
  {
  ...
  },
  {
    ...
    category: "data",
    summary: {
      en: "Download the durable database export.",
      zh: "导出持久化数据库快照。",
    },
  },
];
