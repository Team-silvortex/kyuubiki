...
export function buildWorkbenchUiAutomationContractSnapshot(): WorkbenchUiAutomationContractSnapshot {
  return {
    ...
    selectors: {
      ...
      reportToggle: workbenchAutomationSelectors.reportToggle,
      sidebarResize: workbenchAutomationSelectors.panelResize("sidebar"),
      inspectorResize: workbenchAutomationSelectors.panelResize("inspector"),
      reportResize: workbenchAutomationSelectors.panelResize("report"),
      layoutReset: workbenchAutomationSelectors.layoutReset,
