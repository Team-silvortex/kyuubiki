  ...
  return (
    <div className="workbench-shell">
      ...
      <WorkbenchInspector
        ...
        frameMaxAxialForceValue={isFrameLike || isSpring || isThermalBar || isThermalTruss2d || isThermalTruss3d ? scientific(frameMaxAxialForce) : undefined}
