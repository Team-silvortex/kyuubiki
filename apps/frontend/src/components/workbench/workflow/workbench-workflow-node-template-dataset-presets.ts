...
export const DATASET_VALUE_PRESETS: Record<string, WorkflowDatasetValueInfo> = {
  ...
  frame_p_delta_model: {
    id: "frame_p_delta_model",
    data_class: "study_model",
    element_type: "json_object",
    shape: { axes: [] },
    semantic_type: "study_model/frame_2d_p_delta",
    encoding: "json",
    schema_ref: { schema: "kyuubiki.operator.solve.frame_2d_p_delta.input", version: "1" },
  },
  frame_p_delta_result: {
    id: "frame_p_delta_result",
    data_class: "result",
    element_type: "json_object",
    shape: { axes: [] },
    semantic_type: "result/frame_2d_p_delta",
    encoding: "json",
    schema_ref: { schema: "kyuubiki.operator.solve.frame_2d_p_delta.output", version: "1" },
  },
  thermal_truss_model: {
