...
export function WorkbenchTruss3dWebglViewport(props: Props) {
  const deformationScale = useMemo(() => resolveTruss3dDeformationScale(props.visibleTruss3dNodes, !props.isModelMode), [props.isModelMode, props.visibleTruss3dNodes]);
  ...
  const scene = useMemo(() => buildTruss3dSceneBuffers({ ...props, deformationViewMode }), [
      ...
      >
        ...
        <g clipPath="url(#viewportClipTruss3dWebgl)">
          ...
          {props.visibleTruss3dElements.map((element) => {
            ...
            const startNode = props.displayTruss3dNodes[element.node_i], endNode = props.displayTruss3dNodes[element.node_j];
