...
export const copyEnExtended = {
    ...
    fixPotential: "Fix potential",
    heatLoad: "Heat load",
    temperatureGradientX: "Temperature gradient X",
    temperatureGradientY: "Temperature gradient Y",
    potential: "Potential",
    chargeDensity: "Charge density",
    potentialGradient: "Potential gradient",
    electricField: "Electric field",
    electricFieldMagnitude: "Electric field magnitude",
    electricFluxDensity: "Flux density",
    electricFluxDensityMagnitude: "Flux density magnitude",
    ...
    renderDiagnosticsTitle: "Render Diagnostics",
    renderStrategyLabel: "Strategy",
    renderViewportModeLabel: "Viewport",
    renderStatusLabel: "Status",
    renderFallbackModeLabel: "Fallback",
    renderVisibleLabel: "Visible",
    renderBatchLabel: "Batch",
    renderStatusStable: "Stable",
    renderStatusProgressive: "Progressive",
    renderFallbackDirect: "Direct",
    renderFallbackProgressive: "Progressive viewport",
    renderFallbackChunked: "Chunked result window",
    renderFallbackHybrid: "Chunked + progressive",
    renderModeAxial: "Axial",
    renderModeLine: "Line",
    renderModePlane: "Plane",
    renderModeSpace: "Space",
    renderStrategyAuto: "Auto",
    renderStrategyFull: "Full",
    renderStrategyProgressive: "Progressive",
    renderStrategyFocus: "Focus",
    renderFocusFieldHint: "Focus mode keeps only the most important result fields visible first.",
