...
export const workbenchAutomationSelectors = {
  ...
  workflowBuilderSecondaryTools: '[data-workflow-builder-tools="secondary"]',
  ...
  workflowTopologyAction: (action: string) => `[data-workflow-topology-action="${action}"]`,
  workflowControlPlane: '[data-workflow-control-flow="plane"]',
  workflowControlNode: (nodeId: string) => `[data-workflow-control-node-id="${nodeId}"]`,
  workflowControlEmptyAction: '[data-workflow-control-empty-action="insert"]',
  ...
  dataAction: (action: string) => `[data-workbench-data-action="${action}"]`,
  dataField: (field: string) => `[data-workbench-data-field="${field}"]`,
  dataRecord: (recordId: string) => `[data-workbench-data-record-id="${recordId}"]`,
  dataRecordKind: (kind: string) => `[data-workbench-data-record-kind="${kind}"]`,
  libraryPanel: '[data-workbench-library="panel"]',
  libraryProjectsPanel: '[data-workbench-library-projects="panel"]',
  ...
  libraryProjectAction: (action: string) => `[data-workbench-library-project-action="${action}"]`,
  libraryProjectField: (field: string) => `[data-workbench-library-project-field="${field}"]`,
  ...
  storeEntryAction: (action: string) => `[data-workbench-store-entry-action="${action}"]`,
  storeManifestEntry: (entryId: string) => `[data-workbench-store-manifest-entry-id="${entryId}"]`,
  storeManifestAction: (action: string) => `[data-workbench-store-manifest-action="${action}"]`,
