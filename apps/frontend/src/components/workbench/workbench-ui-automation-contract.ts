...
export const workbenchAutomationSelectors = {
  ...
  inspectorHistory: '[data-workbench-inspector-actions-target="history"]',
  historyAction: (action: string) => `[data-workbench-history-action="${action}"]`,
  historyJob: (jobId: string) => `[data-workbench-history-job-id="${jobId}"]`,
  alert: (alertId: string) => `[data-workbench-alert-id="${alertId}"]`,
  recoveryAction: (action: string) => `[data-workbench-recovery-action="${action}"]`,
  projectHeatToThermo: '[data-workbench-project-heat-to-thermo="true"]',
  console: '[data-workbench-panel="console"]',
  reportToggle: '[data-workbench-report-toggle="true"]',
  panelResize: (panel: string) => `[data-workbench-resize="${panel}"]`,
  layoutReset: '[data-workbench-layout-reset="true"]',
  renderDetails: '[data-workbench-render-details="true"]',
  viewportPanel: '[data-workbench-panel="viewport"]',
  viewportStage: '[data-workbench-viewport="stage"]',
  immersiveToggle: '[data-workbench-immersive="toggle"]',
  immersiveResize: '[data-workbench-immersive-resize="true"]',
  immersiveSave: (control: string) => `[data-workbench-immersive-save="${control}"]`,
  immersiveTab: (tab: string) => `[data-workbench-immersive-tab="${tab}"]`,
  immersiveAction: (action: string) => `[data-workbench-immersive="${action}"]`,
  ...
  materialPage: (page: string) => `[data-workbench-material-page="${page}"]`,
  materialControl: (control: string) => `[data-workbench-material-control="${control}"]`,
  ...
  pwdtWorkspace: '[data-workbench-pwdt="workspace"]',
  pwdtExpand: '[data-workbench-pwdt-expand="true"]',
  pwdtPage: (page: string) => `[data-workbench-pwdt-page="${page}"]`,
  runtimeTabs: '[data-workbench-runtime="tabs"]',
  runtimeNavigation: '[data-workbench-runtime-menu="toggle"]',
  runtimeTab: (page: string) => `[data-workbench-runtime-tab="${page}"]`,
  runtimeStackPage: (page: string) => `[data-workbench-runtime-stack-page="${page}"]`,
  auditPanel: '[data-workbench-audit="panel"]',
  auditPage: (page: string) => `[data-workbench-audit-page="${page}"]`,
  auditFilter: (field: string) => `[data-workbench-audit-filter="${field}"]`,
  auditAction: (action: string) => `[data-workbench-audit-action="${action}"]`,
