export const copyZhExtended = {
    ...
    potential: "电势",
    chargeDensity: "电荷密度",
    potentialGradient: "电势梯度",
    electricField: "电场",
    electricFieldMagnitude: "电场强度",
    electricFluxDensity: "电通量密度",
    electricFluxDensityMagnitude: "电通量密度模",
    thermalIntent: "热载荷意图",
    ...
    chunkSize: "窗口",
    totalElements: "单元",
    renderDiagnosticsTitle: "渲染诊断",
    renderStrategyLabel: "策略",
    renderViewportModeLabel: "视口",
    renderStatusLabel: "状态",
    renderFallbackModeLabel: "降级",
    renderVisibleLabel: "可见",
    renderBatchLabel: "批量",
    renderStatusStable: "稳定",
    renderStatusProgressive: "渐进",
    renderFallbackDirect: "直接渲染",
    renderFallbackProgressive: "渐进视口",
    renderFallbackChunked: "分块结果窗口",
    renderFallbackHybrid: "分块 + 渐进",
    renderModeAxial: "轴向",
    renderModeLine: "线单元",
    renderModePlane: "平面场",
    renderModeSpace: "空间",
    renderStrategyAuto: "自动",
    renderStrategyFull: "完整",
    renderStrategyProgressive: "渐进",
    renderStrategyFocus: "聚焦",
    renderFocusFieldHint: "聚焦模式会优先只显示最关键的结果场。",
    projectLibrary: "项目库",
    ...
    integrityMissingNodes: "求解前请至少添加一个节点。",
    integrityMissingElements: "求解前请至少添加一个单元或杆件。",
    integrityDuplicateNodeId: '节点 "{id}" 出现了重复 ID。',
    integrityDuplicateElementId: '单元 "{id}" 出现了重复 ID。',
    integrityDuplicateMaterialId: '材料 "{id}" 出现了重复 ID。',
    integrityMissingNodeReference: '单元 "{id}" 引用了不存在的节点。',
    integrityMissingMaterialReference: '单元 "{id}" 引用了不存在的材料 "{materialId}"。',
    integrityInvalidNodeField: '节点 "{id}" 的 "{field}" 数值无效。',
    integrityInvalidElementField: '单元 "{id}" 的 "{field}" 数值无效。',
    integrityDegenerateLineElement: '单元 "{id}" 的长度为零或接近于零。',
    integrityDegenerateSurfaceElement: '单元 "{id}" 的面积为零或接近于零。',
    suggestedFixes: "建议修复",
