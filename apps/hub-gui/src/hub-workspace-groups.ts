...
export function renderHubWorkspaceGroups(copy: Record<string, any>): void {
  ...
  const buttons = new Map(
    Array.from(nav.querySelectorAll<HTMLElement>("[data-target]")).map((button) => [
...
function updateHubWorkspaceGroups(copy: Record<string, any>): void {
