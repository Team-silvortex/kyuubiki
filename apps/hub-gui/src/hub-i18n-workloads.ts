...
export const HUB_WORKLOADS_I18N = {
  ...
  zh: {
    library: {
      ...
      workflowCatalogTitle: "运行已发布工作流",
      workflowCatalogCopy: "浏览内置多算子工作流并运行参考样例，无需手动编写计算图。",
    },
    bundles: {
      introLabel: "项目包操作",
      introTitle: "项目包工具",
      ...
      recentOutputs: "最近输出",
      recentActions: "最近项目包操作",
      favorites: "收藏",
      ready: "项目包工具已就绪。",
    },
    guides: {
      directMeshTitle: "直连组网回归测试",
      directMeshCopy: "查看用于检查局域网去中心化网络性能的 Docker 夜间回归测试、基线和验证流程。",
      regressionLabel: "回归通道",
      regressionTitle: "直连组网基线概览",
      regressionCopy: "在管理中心查看局域网组网性能基线，便于核对夜间回归结果。",
      ...
      regressionBaselineCopy: "打开已纳入版本管理的 JSON 基线快照，用于对比直连组网回归结果。",
      regressionOutputTitle: "打开输出目录",
      regressionOutputCopy: "打开本地性能测试输出目录，查看最新摘要和对比报告。",
      regressionLaneTitle: "打开回归指南",
      regressionLaneCopy: "打开测试与持续集成指南，查看夜间测试、结果对比和阈值设置。",
      regressionStatusBaselineOnly: "仅基线",
      regressionStatusWithinBaseline: "基线内",
      regressionStatusRegressed: "已回退",
      regressionNoteBaselineOnly: "尚未加载本地最新摘要。请运行回归测试，或将新摘要放入最新输出目录。",
      regressionNoteWithinBaseline: "已检测到本地最新摘要，直连组网性能仍在当前基线范围内。",
      regressionNoteRegressed: "已检测到本地最新摘要，但耗时或资源占用超过当前基线阈值。",
    },
  },
  ja: {
    library: {
...
export function applyHubWorkloadsI18n(target: HubI18nRegistry): void {
