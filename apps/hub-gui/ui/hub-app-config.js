...
export const HUB_ASSISTANT_MODEL_PRESETS = ["gpt-5", "gpt-5-mini", "gpt-4.1", "custom"];
export const HUB_ASSISTANT_ACTION_RISK = {
...
export const HUB_DIRECT_ACTION_RISK = {
    ...
    "hot-stop": "sensitive",
    "project-create": "sensitive",
    "project-normalize": "sensitive",
    "project-unpack": "sensitive",
    "project-pack": "high",
};
export const HUB_ASSISTANT_ACTIONS = [
    ...
    { id: "hub/projectCreate", summary: "Create a project bundle and make it the active bundle.", payloadExample: { path: "" } },
...
export const HUB_DENSITY_DEFAULTS = {
