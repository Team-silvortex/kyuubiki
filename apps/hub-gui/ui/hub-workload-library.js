...
export function validateRemoteWorkloadCatalogPayload(payload) {
    ...
    for (const [index, rawWorkload] of catalog.workloads.entries()) {
        ...
        const hasRequiredLocator = String(workload.download_url || "").trim() ||
        ...
        if (workload.analysis_domains !== undefined &&
            (!Array.isArray(workload.analysis_domains) ||
                workload.analysis_domains.some((value) => typeof value !== "string" ||
        ...
        if (workload.analysis_families !== undefined &&
            (!Array.isArray(workload.analysis_families) ||
                workload.analysis_families.some((value) => typeof value !== "string" ||
        ...
        if (workload.thermal_intents !== undefined &&
