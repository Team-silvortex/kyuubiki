Code.require_file("workflow_api_triangle_fixtures.exs", __DIR__)

defmodule KyuubikiWeb.TestSupport.WorkflowApiFixtures do
  @moduledoc false

  alias KyuubikiWeb.TestSupport.WorkflowApiTriangleFixtures
  ...
  def guarded_triangle_frames(:blocked),
    do: [[WorkflowApiTriangleFixtures.electrostatic_result(:blocked)]]

  def guarded_triangle_frames(:continued) do
    [
      [WorkflowApiTriangleFixtures.electrostatic_result(:continued)],
      [WorkflowApiTriangleFixtures.heat_result()],
      [WorkflowApiTriangleFixtures.thermo_result()]
    ]
  end
