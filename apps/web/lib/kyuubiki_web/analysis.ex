defmodule KyuubikiWeb.Analysis do
  ...
  defdelegate submit_composite_thermo_electric_panel(params), to: AnalysisSolverSubmissions
  ...
  defdelegate submit_cohesive_interface_mesh_2d(params), to: AnalysisSolverSubmissions
  defdelegate submit_cohesive_interface_mesh_3d(params), to: AnalysisSolverSubmissions
  ...
  defdelegate submit_frame_2d_p_delta(params), to: AnalysisSolverSubmissions
  defdelegate submit_frame_2d_material_p_delta(params), to: AnalysisSolverSubmissions
