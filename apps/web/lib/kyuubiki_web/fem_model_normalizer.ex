defmodule KyuubikiWeb.FemModelNormalizer do
  ...
  def normalize_thermal_truss_2d(params), do: normalize_graph_model(params, :invalid_thermal_truss_model)
  def normalize_truss_3d(params), do: normalize_graph_model(params, :invalid_truss_3d_model)
  def normalize_thermal_truss_3d(params), do: normalize_graph_model(params, :invalid_thermal_truss_3d_model)
  def normalize_plane_triangle_2d(params), do: normalize_graph_model(params, :invalid_plane_model)
  def normalize_thermal_plane_triangle_2d(params), do: normalize_graph_model(params, :invalid_thermal_plane_model)
  def normalize_plane_quad_2d(params), do: normalize_graph_model(params, :invalid_plane_quad_model)
  def normalize_thermal_plane_quad_2d(params), do: normalize_graph_model(params, :invalid_thermal_plane_quad_model)
  def normalize_beam_1d(params), do: normalize_graph_model(params, :invalid_beam_model)
  def normalize_thermal_beam_1d(params), do: normalize_graph_model(params, :invalid_thermal_beam_model)
  def normalize_thermal_bar_1d(params), do: normalize_graph_model(params, :invalid_thermal_bar_model)
  def normalize_heat_bar_1d(params), do: normalize_graph_model(params, :invalid_heat_bar_model)
  def normalize_electrostatic_bar_1d(params), do: normalize_graph_model(params, :invalid_electrostatic_bar_model)
  ...
  def normalize_thermal_frame_2d(params), do: normalize_graph_model(params, :invalid_thermal_frame_model)
  def normalize_thermal_frame_3d(params), do: normalize_graph_model(params, :invalid_thermal_frame_3d_model)
