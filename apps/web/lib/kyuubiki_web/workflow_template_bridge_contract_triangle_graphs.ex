defmodule KyuubikiWeb.WorkflowTemplateBridgeContractTriangleGraphs do
  @moduledoc false

  import KyuubikiWeb.WorkflowTemplateBridgeContractGraphSupport,
    only: [edge: 7, heat_triangle_seed_model_example: 0]

  alias KyuubikiWeb.WorkflowCatalogSupport

  def electrostatic_to_heat_triangle_graph do
    %{
      "schema_version" => "kyuubiki.workflow-graph/v1",
      "id" => "workflow.electrostatic-to-heat-triangle-2d",
      "name" => "Electrostatic to heat triangle",
      "version" => "1.0.0",
      "dataset_contract" =>
        WorkflowCatalogSupport.workflow_dataset_contract(
          "kyuubiki.dataset.electrostatic_to_heat_triangle/v1",
          [
