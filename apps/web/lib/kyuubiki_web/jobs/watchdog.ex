defmodule KyuubikiWeb.Jobs.Watchdog do
  ...
  defp summarize_agent_load(%{snapshot: snapshot, agents: agents, gate: gate}, state) do
    ...
    %{
      ...
      capacity_by_endpoint: Map.get(gate, :capacity_by_endpoint, %{}),
      utilization_by_endpoint: Map.get(gate, :utilization_by_endpoint, %{}),
      saturated_endpoint_count: Map.get(gate, :saturated_endpoint_count, 0),
      selection_policy: Map.get(gate, :selection_policy),
