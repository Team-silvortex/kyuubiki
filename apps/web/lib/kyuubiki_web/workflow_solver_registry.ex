defmodule KyuubikiWeb.WorkflowSolverRegistry do
  ...
  @solver_specs [
    ...
    {"solve.solid_tetra_3d", :solve_solid_tetra_3d, "mechanical", "solid_tetra_3d",
     "Solve a 3D solid tetrahedral model with displacement, strain, stress, and von Mises outputs.",
     ["verified", "mechanical", "solid", "tetra", "3d"]},
    ...
    {"solve.heat_plane_quad_2d", :solve_heat_plane_quad_2d, "thermal", "heat_plane_quad_2d",
     "Solve 2D steady heat conduction on quads, optionally joining matching boundary edges through finite thermal contact resistance.",
     [
       "verified",
       "thermal",
       "heat",
    ...
    {"solve.transient_heat_bar_1d", :solve_transient_heat_bar_1d, "thermal",
     "transient_heat_bar_1d",
     "Solve a transient 1D heat-conduction bar model with implicit time stepping.",
     ["verified", "thermal", "heat", "transient", "bar", "1d"]},
    {"solve.heat_plane_triangle_2d", :solve_heat_plane_triangle_2d, "thermal",
     "heat_plane_triangle_2d",
     "Solve 2D steady heat conduction on triangles, optionally joining matching boundary edges through finite thermal contact resistance.",
     [
       "verified",
       "thermal",
       "heat",
    ...
    {"solve.transient_spring_1d", :solve_transient_spring_1d, "mechanical", "transient_spring_1d",
     "Solve a transient 1D mass-spring chain with Newmark time integration.",
     ["verified", "mechanical", "spring", "transient", "dynamics", "1d"]},
    {"solve.harmonic_spring_1d", :solve_harmonic_spring_1d, "mechanical", "harmonic_spring_1d",
     "Solve a damped 1D spring-chain frequency response sweep.",
     ["verified", "mechanical", "spring", "harmonic", "frequency", "1d"]},
    ...
    {"solve.buckling_beam_1d", :solve_buckling_beam_1d, "mechanical", "buckling_beam_1d",
     "Solve linear eigenvalue buckling for a beam-column and emit critical load factors and mode shapes.",
     ["screening", "mechanical", "buckling", "stability", "beam", "1d"]},
    {"solve.buckling_frame_2d", :solve_buckling_frame_2d, "mechanical", "buckling_frame_2d",
     "Solve linear eigenvalue buckling for a statically preloaded 2D frame.",
     ["screening", "mechanical", "buckling", "stability", "frame", "2d"]},
    {"solve.frame_2d_p_delta", :solve_frame_2d_p_delta, "mechanical", "frame_2d_p_delta",
     "Solve a precritical P-Delta path for a mode-imperfect 2D frame.",
     ["screening", "mechanical", "stability", "frame", "p_delta", "imperfection", "2d"]},
