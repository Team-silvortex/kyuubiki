      ...
      <div class="integrity-policy-grid">
        <article class="integrity-policy-card desktop-shell-surface-card">
          ...
          <ul class="integrity-policy-list">
            ...
            <li>Desktop shells, release manifests, and runtime layout must stay version-aligned to \`tamamono 1.20.0\`.</li>
          </ul>
        ...
        <article class="integrity-policy-card desktop-shell-surface-card">
          ...
          <div class="integrity-target-grid">
            ...
            <div><span>Version</span><strong id="integrity-version-value">1.20.0</strong></div>
          </div>
...
export function renderIntegrityReport(report, brandConfig = null) {
  ...
  const releaseVersion = String(brandConfig?.releaseVersion || report?.current_version || "1.20.0").replace(
    /^v/u,
    "",
  );
