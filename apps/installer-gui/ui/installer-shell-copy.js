...
const installerShellCopy = {
  ...
  es: {
    ...
    roleChip: "Instalación y despliegue",
    description: "Instalador visual para SQLite local, PostgreSQL en la nube y preparación de versiones.",
    pwdtStatus: "Pwdt vive primero en Workbench; Installer conserva solo diagnósticos restringidos.",
    actions: {
      doctor: "Ejecutar diagnóstico",
      bootstrap: "Inicializar espacio de trabajo",
      serviceStatus: "Comprobar servicios",
      writeEnv: "Escribir entorno",
      validateEnv: "Validar entorno",
      stageRelease: "Preparar versión",
      buildInstaller: "Compilar instalador",
      clearOutput: "Limpiar",
    },
    tabs: ["Asistente", "Configuración", "Integridad", "Actualizaciones", "Servicios", "Remoto", "Versiones", "Salida"],
    headings: {
      wizard: "Asistente de instalación",
      setup: "Elegir modo de despliegue",
      environment: "Entorno",
      doctor: "Comprobaciones de diagnóstico",
      services: "Ejecutar todos los servicios",
      status: "Estado actual del servicio",
      logs: "Registros de ejecución",
      release: "Preparar directorio de la versión",
      output: "Salida del instalador",
    },
    completion: "Proceso de instalación actualizado.",
    ready: "Listo para el siguiente paso.",
    restartHint: "Reinicia las aplicaciones abiertas si no se actualiza el idioma.",
  },
};
