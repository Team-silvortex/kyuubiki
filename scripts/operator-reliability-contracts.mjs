export const operatorReliabilityPaths = {
  manifest: "config/operator-reliability-manifest.json",
...
export const operatorReliabilitySchemaVersions = {
  manifest: "kyuubiki.operator-reliability-manifest/v1",
  shard: "kyuubiki.operator-reliability-shard/v1",
