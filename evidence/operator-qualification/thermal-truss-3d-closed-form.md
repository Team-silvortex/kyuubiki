...
non-finite 3D node coordinates and degenerate thermal truss element topology, so
the retained qualification includes explicit robustness evidence in addition to
the objectivity regression.
