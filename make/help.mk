...
help:
	...
	@echo "  make desktop-build-host Build three shells with a shared Cargo cache; optional BUNDLES=app|deb|nsis"
	...
	@echo "  make check-contracts-validation-qualification Recheck retained contracts-validation qualification evidence"
	...
	@echo "  make qualify-runtime-payload-operational-remote Exercise sealed Runtime payload upgrade, service probes, and rollback on remote Linux"
	...
	@echo "  make qualify-operator-sdk-windows-operational Capture installed-agent evidence on native Windows"
	@echo "  make check-operator-sdk-windows-operational-qualification Verify the Windows contract or retained report"
