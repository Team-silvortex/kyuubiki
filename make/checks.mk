...
check-test-coverage-posture:
	@$(ENTRYPOINT) check-test-coverage-posture --self-test
	@$(ENTRYPOINT) check-test-coverage-posture --out $${OUT:-tmp/test-coverage-posture.json} --markdown-out $${MARKDOWN_OUT:-tmp/test-coverage-posture.md}
...
check-usability-release-gate:
	...
	@$(ENTRYPOINT) check-usability-release-gate

build-usability-readiness-report:
	@$(ENTRYPOINT) check-usability-release-gate --execute --out $${OUT:-tmp/usability-readiness-report.json}

check-runtime-recovery-fault-injection:
	@$(ENTRYPOINT) check-runtime-recovery-fault-injection --self-test
	@$(ENTRYPOINT) check-runtime-recovery-fault-injection --out $${OUT:-tmp/runtime-recovery-fault-injection.json}
...
check-desktop-ui-validation:
	...
	@$(ENTRYPOINT) check-desktop-ui-validation --verify-report releases/usability-evidence/3.2.0/desktop-ui-validation-recovery.json
...
check-orchestra-installed-takeover-operational-qualification:
	...
	@$(ENTRYPOINT) check-orchestra-installed-takeover-operational-qualification --verify-report releases/usability-evidence/2.15.0/orchestra-installed-takeover-operational-qualification.json
...
check-persistence-provenance-qualification:
	...
	@$(ENTRYPOINT) check-persistence-provenance-qualification --verify-report releases/usability-evidence/2.15.0/persistence-provenance-qualification.json
...
check-benchmark-qualification:
	...
	@$(ENTRYPOINT) check-benchmark-qualification --verify-report releases/usability-evidence/2.15.0/benchmark-qualification.json

check-orchestra-benchmark-qualification:
	@$(ENTRYPOINT) check-orchestra-benchmark-qualification --self-test
	@$(ENTRYPOINT) check-orchestra-benchmark-qualification --verify-report releases/usability-evidence/2.15.0/orchestra-benchmark-qualification.json
...
architecture-check:
	...
	@$(MAKE) check-orchestra-benchmark-qualification
	...
	@$(MAKE) check-desktop-ui-validation
