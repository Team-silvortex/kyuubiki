...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 1200 | 0 | skipped | n/a | n/a | n/a | n/a | dry_run/blocked | 2 | n/a |
...
- headless_run_exec_round_1: skipped
- headless_run_bad_alias: skipped（预期失败）
- headless_run_missing_report_out: skipped（预期失败）

观察结果：
- 模板为 blocked-by-design，dry-run 阶段状态为 blocked，已跳过 execute 与 boundary 回归。
