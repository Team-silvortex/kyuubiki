use kyuubiki_headless_sdk::{
    ...
    workflow_operator_fetch_entry, workflow_port, workflow_schema_ref, workflow_shape, WORKFLOW_DATASET_SCHEMA_VERSION,
...
fn builds_valid_graph() {
    ...
    assert_eq!(graph.defaults.as_ref().and_then(|item| item.orchestrated), Some(false));
