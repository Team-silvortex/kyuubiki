...
def _selected_surface(
    ...
    field_sources = {
        ...
        "frontier_digest": (execution, "frontier_digest", f"execution_contract.surfaces.{sdk}.frontier_digest"),
        "frontier_validator": (execution, "frontier_validator", f"execution_contract.surfaces.{sdk}.frontier_validator"),
        "frontier_digest_verifier": (execution, "frontier_digest_verifier", f"execution_contract.surfaces.{sdk}.frontier_digest_verifier"),
