defmodule KyuubikiSdk do
  ...
  def normalize_workflow_progression(history, result_payload \\ nil), do: WorkflowResults.normalize_progression(history, result_payload)
  def normalize_workflow_runtime(payload), do: WorkflowResults.normalize_runtime(payload)
  def validate_workflow_result_against_graph(graph, payload), do: WorkflowResults.validate_result_against_graph(graph, payload)
  ...
  defdelegate workflow_operator_fetch_entry(node_id, operator_id, attrs \\ %{}), to: WorkflowBuilders, as: :operator_fetch_entry
