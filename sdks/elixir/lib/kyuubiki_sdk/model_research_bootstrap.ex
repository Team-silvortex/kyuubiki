  ...
  defp selected_surface(bootstrap, sdk, resources, blockers) do
    ...
    if is_nil(collaboration) or is_nil(preflight) or is_nil(execution) do
      ...
      definitions = [
        ...
        {"frontier_digest", execution, "frontier_digest",
         "execution_contract.surfaces.#{sdk}.frontier_digest", false},
        {"frontier_validator", execution, "frontier_validator",
         "execution_contract.surfaces.#{sdk}.frontier_validator", false},
        {"frontier_digest_verifier", execution, "frontier_digest_verifier",
         "execution_contract.surfaces.#{sdk}.frontier_digest_verifier", false},
