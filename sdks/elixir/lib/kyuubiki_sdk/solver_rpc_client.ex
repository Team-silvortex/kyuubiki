defmodule KyuubikiSdk.SolverRpcClient do
  ...
  @solver_methods %{
    ...
    "frame_2d_material_p_delta" => "solve_frame_2d_material_p_delta",
  ...
  def solve_buckling_beam_1d(client, payload),
    do: solve_study(client, "buckling_beam_1d", payload)
  ...
  def solve_frame_2d_material_p_delta(client, payload),
    do: solve_study(client, "frame_2d_material_p_delta", payload)
