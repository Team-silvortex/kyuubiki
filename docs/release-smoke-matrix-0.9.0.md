...
| `thermal_bar_1d` | [x] | [x] | [ ] | [x] | [x] | Official sample: `Thermal Bar 1D`. Manual sample open and report/export path in Workbench were verified on `2026-05-17`. Playwright UI smoke also passed on `2026-05-20`; the sample opened in the real UI under `Thermo-mechanical` and exposed `Report`, `Export Data JSON`, and `Export Data CSV`. Local orchestrated smoke passed on `2026-05-17`; `max_stress=100800000`, `max_axial_force=1008000`. |
...
| `spring_2d` | [x] | [x] | [x] | [x] | [x] | `minimal` family in `v0.9.0`. Local orchestrated smoke passed on `2026-05-20` with the official sample `Spring Grid 2D`; `max_displacement≈0.0634`, `max_force≈1120.75`, `nodes=4`, `elements=5`. Direct-mesh smoke also passed on `2026-05-20` with the same sample through `/api/direct-mesh/solve`; `max_displacement≈0.0634`, `max_force≈1120.75`, `worker=direct-mesh@127.0.0.1:5001`. Workbench UI smoke also passed on `2026-05-20`; the sample opened in the real UI and exposed `Report`, `Export Data JSON`, and `Export Data CSV`. |
| `spring_3d` | [x] | [x] | [x] | [x] | [x] | `minimal` family in `v0.9.0`. Local orchestrated smoke passed on `2026-05-20` with the official sample `Spring Cage 3D`; `max_displacement≈0.0596`, `max_force≈803.01`, `nodes=4`, `elements=6`. Direct-mesh smoke also passed on `2026-05-20` with the same sample through `/api/direct-mesh/solve`; `max_displacement≈0.0596`, `max_force≈803.01`, `worker=direct-mesh@127.0.0.1:5001`. Workbench UI smoke also passed on `2026-05-20`; the sample opened in the real UI and exposed `Report`, `Export Data JSON`, and `Export Data CSV`. |
...
| `frame_2d` | [x] | [x] | [ ] | [x] | [x] | Official sample: `Portal Frame 2D`. Manual sample open and report/export path in Workbench were verified on `2026-05-17`. Playwright UI smoke also passed on `2026-05-20`; the sample opened in the real UI and exposed `Report`, `Export Data JSON`, and `Export Data CSV`. Local orchestrated smoke passed on `2026-05-17`; `max_moment≈2000`, `max_stress≈1.25e7`. |
...
| `plane_quad_2d` | [x] | [x] | [ ] | [x] | [x] | Official sample: `Quad Plate Patch 2D`. Manual sample open and report/export path in Workbench were verified on `2026-05-17`. Playwright UI smoke also passed on `2026-05-20`; the sample opened in the real UI under `Mechanical` and exposed `Report`, `Export Data JSON`, and `Export Data CSV`. Local orchestrated smoke passed on `2026-05-17`; `max_stress≈60221.34`, `elements=1`. |

### Thermal UI Coverage Notes

- `heat_bar_1d`
  Workbench UI smoke passed on `2026-05-20`; `Heat Bar 1D` opened in the real UI under `Thermal` and exposed `Report`, `Export Data JSON`, and `Export Data CSV`.
- `heat_plane_quad_2d`
  Workbench UI smoke passed on `2026-05-20`; `Heat Plane Quad 2D` opened in the real UI under `Thermal` and exposed `Report`, `Export Data JSON`, and `Export Data CSV`.
- `thermal_plane_quad_2d`
  Workbench UI smoke passed on `2026-05-20`; `Thermal Plane Quad 2D` opened in the real UI under `Thermo-mechanical` and exposed `Report`, `Export Data JSON`, and `Export Data CSV`.
