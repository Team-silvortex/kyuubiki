...
- sample-backed `thermal_beam_1d`, `heat_bar_1d`, `heat_plane_triangle_2d`, `heat_plane_quad_2d`, `frame_3d`, `plane_quad_2d`, `thermal_frame_2d`, `thermal_plane_triangle_2d`, `thermal_plane_quad_2d`, `thermal_truss_2d`, `thermal_frame_3d`, and `thermal_truss_3d` orchestrated API smoke
