use kyuubiki_protocol::{
    ...
    Frame2dEquilibriumPathEvent, Frame2dImperfectionSource, Frame2dPDeltaFailureReason,
    Frame2dStabilityKinematics, Frame2dStabilityPathControl, Frame2dTangentStability,
};
use kyuubiki_solver::solve_frame_2d_p_delta;

#[path = "frame_2d_p_delta_explicit_imperfection/fixtures.rs"]
mod fixtures;

use fixtures::{portal_request, shallow_arch_request};
