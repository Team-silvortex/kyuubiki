...
#[derive(Debug, Clone)]
pub(super) struct ElectrostaticPlaneTriangleComputed {
...
#[derive(Debug, Clone)]
pub(super) struct ElectrostaticPlaneQuadComputed {
    pub first: ElectrostaticPlaneTriangleComputed,
    pub second: ElectrostaticPlaneTriangleComputed,
}
...
pub(super) fn precompute_electrostatic_plane_triangle_element(
    ...
    precompute_electrostatic_plane_triangle_element_from_nodes(&request.nodes, element)
}
...
pub(super) fn precompute_electrostatic_plane_quad_element(
    ...
    Ok(ElectrostaticPlaneQuadComputed {
        first: precompute_electrostatic_plane_triangle_element_from_nodes(&request.nodes, &first)?,
        second: precompute_electrostatic_plane_triangle_element_from_nodes(
            &request.nodes,
            &second,
        )?,
    })
...
fn precompute_electrostatic_plane_triangle_element_from_nodes(
