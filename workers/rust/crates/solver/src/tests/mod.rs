use super::{
    MockSolver, profile_plane_quad_2d, profile_truss_2d, solve_acoustic_bar_1d,
    solve_advection_diffusion_bar_1d, solve_bar_1d, solve_beam_1d, solve_electrostatic_bar_1d,
