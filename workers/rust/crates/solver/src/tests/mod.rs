use super::{
    MockSolver, solve_acoustic_bar_1d, solve_advection_diffusion_bar_1d, solve_bar_1d,
    solve_beam_1d, solve_electrostatic_bar_1d, solve_electrostatic_plane_quad_2d,
    ...
    solve_spring_3d, solve_stokes_flow_plane_quad_2d, solve_thermal_bar_1d, solve_thermal_beam_1d,
