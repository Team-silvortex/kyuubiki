use super::{
    MockSolver, solve_acoustic_bar_1d, solve_bar_1d, solve_beam_1d, solve_electrostatic_bar_1d,
    ...
    solve_magnetostatic_bar_1d, solve_plane_quad_2d, solve_plane_triangle_2d, solve_spring_1d,
...
use kyuubiki_protocol::{
    AcousticBar1dElementInput, AcousticBar1dNodeInput, Beam1dElementInput, Beam1dNodeInput,
    ...
    SolveAcousticBar1dRequest, SolveBarRequest, SolveBeam1dRequest, SolveElectrostaticBar1dRequest,
    ...
    SolveTorsion1dRequest, SolveTruss2dRequest, SolveTruss3dRequest, Spring1dElementInput,
    Spring1dNodeInput, Spring2dElementInput, Spring2dNodeInput, Spring3dElementInput,
    Spring3dNodeInput, StokesFlowPlaneNodeInput, StokesFlowPlaneQuadElementInput,
