...
mod prelude {
    pub(super) use crate::{
        ...
        SolveFrame2dRequest, SolveFrame3dRequest, SolveHarmonicSpring1dRequest,
        ...
        SolveThermalTruss2dRequest, SolveTorsion1dRequest, SolveTransientHeatBar1dRequest,
        SolveTransientSpring1dRequest, SolveTruss3dRequest, SolverExecutionCapability,
