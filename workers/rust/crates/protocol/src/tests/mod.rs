...
mod prelude {
    pub(super) use crate::{
        ...
        MagnetostaticBar1dNodeInput, OperatorArtifactRef, OperatorDescriptor, OperatorKind,
        OperatorOrigin, OperatorPortDescriptor, OperatorRunContext, OperatorRunRequest,
        OperatorRunResult, OperatorSchemaRef, OperatorValidationProfile, OperatorValidationStatus,
        PlaneQuadElementInput, ProgressEvent, RPC_VERSION, RpcMethod, RpcProgress, RpcRequest,
        RpcResponse, SolveBarRequest, SolveBeam1dRequest, SolveElectrostaticBar1dRequest,
