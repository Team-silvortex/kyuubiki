...
use crate::{
    ...
    SolveCohesiveInterfaceMesh2dResult, SolveContactGap1dResult,
    SolveElectricConductionPlaneQuad2dResult, SolveElectrostaticBar1dResult,
    SolveElectrostaticPlaneQuad2dResult, SolveElectrostaticPlaneTriangle2dResult,
    SolveFrame2dMaterialPDeltaResult, SolveFrame2dPDeltaPathResult, SolveFrame2dPDeltaResult,
