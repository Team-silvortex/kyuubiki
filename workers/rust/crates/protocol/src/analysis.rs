...
use crate::{
    ...
    SolveCohesiveInterface1dResult, SolveCohesiveInterface2dResult,
    SolveCohesiveInterfaceMesh2dResult, SolveCohesiveInterfaceMesh3dResult,
    SolveContactGap1dResult, SolveElectricConductionPlaneQuad2dResult,
    SolveElectrostaticBar1dResult, SolveElectrostaticPlaneQuad2dResult,
    SolveElectrostaticPlaneTriangle2dResult, SolveFrame2dMaterialPDeltaResult,
    SolveFrame2dPDeltaPathResult, SolveFrame2dPDeltaResult, SolveFrame2dResult, SolveFrame3dResult,
...
pub enum AnalysisResult {
    ...
    ElectricConductionPlaneQuad2d(SolveElectricConductionPlaneQuad2dResult),
    ...
    CohesiveInterface1d(SolveCohesiveInterface1dResult),
    CohesiveInterface2d(SolveCohesiveInterface2dResult),
    CohesiveInterfaceMesh2d(SolveCohesiveInterfaceMesh2dResult),
    CohesiveInterfaceMesh3d(SolveCohesiveInterfaceMesh3dResult),
    ...
    Frame2dMaterialPDelta(SolveFrame2dMaterialPDeltaResult),
}
