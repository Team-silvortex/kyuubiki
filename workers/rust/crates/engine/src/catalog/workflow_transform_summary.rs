...
pub(super) fn workflow_summary_transform_descriptors() -> Vec<OperatorDescriptor> {
    vec![
        ...
        built_in_explicit_transform_descriptor(
            ...
            [("artifact/result_summary", "result_summary"); 3],
        ),
        built_in_explicit_transform_descriptor(
        ...
        built_in_explicit_transform_descriptor(
            ...
            "multi_domain",
            "validate_summary_tolerance",
            "Validate two summary payloads against absolute and relative tolerances and emit a pass/block reliability gate.",
            &[
                "transform",
                "summary",
                "validation",
        ...
        built_in_transform_descriptor(
            ...
            "Convert quality candidate rankings and coupled-readiness envelopes into a stop, continue, review, or replan request for the next exploration round.",
            &[
                "transform",
                "summary",
                "next_round",
        ...
        built_in_transform_descriptor(
            ...
            "Compose a machine-readable lineage report from quality ranking, coupled-readiness repair intent, sweep plan, and expanded cases.",
            &[
                "transform",
                "summary",
                "lineage",
        ...
        built_in_transform_descriptor(
            ...
            "Convert a quality next-round request into a parameter sweep plan, including coupled-readiness repair and review focus axes.",
            &[
                "transform",
                "summary",
                "parameter_sweep",
