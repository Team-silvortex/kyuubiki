...
fn solver_descriptors() -> Vec<OperatorDescriptor> {
    vec![
        ...
        built_in_solver_descriptor(
            ...
            "Solve steady 2D electric conduction with contact resistance and impedance terminals, exposing fields and power-balance receipts.",
            &[
                "verified",
                "electromagnetic",
                "electric-conduction",
        ...
        built_in_solver_descriptor(
            ...
            "mechanical",
            "frame_2d_p_delta",
            "Solve a 2D frame stability path with mode-scaled or explicit imperfections, load-controlled P-Delta screening, and experimental corotational arc-length continuation.",
            &[
                "screening",
                "mechanical",
                "stability",
        ...
        built_in_solver_descriptor(
            ...
            "Solve a constrained multi-element 2D cohesive interface mesh with sparse global Newton assembly, committed damage history, observable linear-solver paths, and spring, truss, triangle, Q4, or frame host co-assembly.",
            &[
                "screening",
                "mechanical",
                "interface",
