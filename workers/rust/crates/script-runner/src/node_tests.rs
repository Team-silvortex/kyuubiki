    ...
    let result = match command {
        ...
        "integration-desktop-gui-node-test" => run_node_test_serial(
            ...
            &[
                ...
                "tests/integration/desktop-gui-compact-navigation.test.mjs",
                "tests/integration/desktop-gui-layout-priority.test.mjs",
                "tests/integration/desktop-gui-navigation-closure.test.mjs",
                "tests/integration/desktop-hub-assistant-context.test.mjs",
                "tests/integration/desktop-installer-action-recovery.test.mjs",
                "tests/integration/desktop-shell-regression.test.mjs",
                "tests/integration/http-preview-lifecycle.test.mjs",
        ...
        "integration-ui-workflow-node-test" => run_node_test_serial(
            ...
            &[
                ...
                "tests/integration/workbench-ui-modeling-performance.test.mjs",
                "tests/integration/workbench-ui-large-model-lod.test.mjs",
                "tests/integration/workbench-ui-model-batch.test.mjs",
                "tests/integration/workbench-ui-immersive-modeling.test.mjs",
                ...
                "tests/integration/workbench-ui-checkpoint-recovery.test.mjs",
                "tests/integration/workbench-ui-checkpoint-reopen.test.mjs",
                "tests/integration/workbench-ui-pwdt-completion.test.mjs",
                "tests/integration/workbench-ui-pwdt-runtime.test.mjs",
                "tests/integration/workbench-ui-pwdt-workspace.test.mjs",
                "tests/integration/workbench-ui-compact-panels.test.mjs",
                "tests/integration/workbench-ui-research-actions.test.mjs",
                "tests/integration/workbench-ui-greek-localization.test.mjs",
                "tests/integration/workbench-ui-language-fragment-localization.test.mjs",
