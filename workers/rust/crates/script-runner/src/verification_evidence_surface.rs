...
fn assert_surface(root: &Path, surface: &Value) -> RunnerResult<()> {
    ...
    assert_includes(
        &string_array_at(surface, "/runtime_api/stable_commands"),
        "./scripts/kyuubiki check-protocol-validation-qualification",
        "stable command",
    )?;
    assert_includes(
        &string_array_at(surface, "/runtime_api/stable_commands"),
    ...
    assert_includes(
        &string_array_at(surface, "/runtime_api/stable_commands"),
        "./scripts/kyuubiki check-desktop-ui-validation",
        "stable command",
    )?;
    assert_includes(
        &string_array_at(surface, "/runtime_api/stable_commands"),
    ...
    assert_includes(
        &string_array_at(surface, "/runtime_api/stable_commands"),
        "./scripts/kyuubiki check-agent-control-link-operational-qualification",
        "stable command",
    )?;
    assert_includes(
        &string_array_at(surface, "/runtime_api/stable_commands"),
    ...
    assert_includes(
        &string_array_at(surface, "/runtime_api/generated_artifacts"),
        "tmp/desktop-ui-validation-report.json",
        "generated artifact",
    )?;
    assert_includes(
        &string_array_at(surface, "/runtime_api/generated_artifacts"),
    ...
    assert_includes(
        &string_array_at(surface, "/runtime_api/generated_artifacts"),
        "tmp/agent-control-link-operational-qualification.json",
        "generated artifact",
    )?;
    assert_includes(
        &string_array_at(surface, "/runtime_api/generated_artifacts"),
