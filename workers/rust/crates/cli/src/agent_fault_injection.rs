...
fn validate_stage(
    ...
    match stage {
        ...
        "sparse_validate_rhs" => Ok(Some(SolverStage::SparseValidateRhs)),
        "sparse_validate_matrix" => Ok(Some(SolverStage::SparseValidateMatrix)),
        "sparse_validate_matrix_row" => Ok(Some(SolverStage::SparseValidateMatrixRow)),
        "sparse_diagonal_scale" => Ok(Some(SolverStage::SparseDiagonalScale)),
        "sparse_rhs_scale" => Ok(Some(SolverStage::SparseRhsScale)),
        "sparse_solution_unscale" => Ok(Some(SolverStage::SparseSolutionUnscale)),
        "sparse_diagonal_magnitude" => Ok(Some(SolverStage::SparseDiagonalMagnitude)),
        "sparse_capacity_scan" => Ok(Some(SolverStage::SparseCapacityScan)),
        "sparse_matrix_scale" => Ok(Some(SolverStage::SparseMatrixScale)),
        "sparse_matrix_scale_row" => Ok(Some(SolverStage::SparseMatrixScaleRow)),
...
mod tests {
    ...
    fn numerical_hold_requires_an_explicit_supported_stage_and_method() {
        ...
        for stage in [
            ...
            "sparse_validate_matrix_row",
            "sparse_diagonal_scale",
            "sparse_rhs_scale",
            "sparse_solution_unscale",
            "sparse_diagonal_magnitude",
            "sparse_capacity_scan",
            "sparse_matrix_scale",
            "sparse_matrix_scale_row",
