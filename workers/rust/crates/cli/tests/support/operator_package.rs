...
pub fn exercise_live_agent_package_journey(packages_root: &Path, entrypoint_sha256: &str) {
...
pub fn template_packages_root() -> PathBuf {
...
pub fn template_package_root() -> PathBuf {
    template_packages_root().join("operator-crate-template")
}

pub fn template_library_path(packages_root: &Path) -> PathBuf {
    packages_root
