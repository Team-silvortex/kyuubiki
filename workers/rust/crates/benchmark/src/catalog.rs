...
fn build_case(template: &CaseTemplateSpec, profile: &ProfileScaleSpec) -> BenchmarkCase {
    ...
    match template.family {
        ...
        BenchmarkFamily::BucklingBeam1d => BenchmarkCase {
            id,
            family: "buckling_beam_1d",
            workload: BenchmarkWorkload::BucklingBeam1d(generate_buckling_beam_1d_case(
                profile.axial_elements,
                profile.space_frame.width,
            )),
        },
        BenchmarkFamily::BucklingFrame2d => BenchmarkCase {
            id,
        ...
        BenchmarkFamily::Frame2dCorotational => BenchmarkCase {
            id,
            family: "frame_2d_corotational",
            workload: BenchmarkWorkload::Frame2dPDelta(generate_frame_2d_corotational_case(
                profile.axial_elements,
                profile.space_frame.width,
            )),
        },
