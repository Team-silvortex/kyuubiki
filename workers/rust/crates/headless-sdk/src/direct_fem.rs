...
const DIRECT_FEM_ROUTES: &[DirectFemRoute] = &[
    ...
    DirectFemRoute {
        action: "solve_magnetostatic_bar_1d",
    ...
    DirectFemRoute {
        action: "solve_magnetostatic_plane_quad_2d",
        route: "/api/v1/fem/magnetostatic-plane-quad-2d/jobs",
    },
    DirectFemRoute {
    ...
    DirectFemRoute {
        action: "solve_stokes_flow_plane_triangle_2d",
        route: "/api/v1/fem/stokes-flow-plane-triangle-2d/jobs",
    },
    DirectFemRoute {
    ...
    DirectFemRoute {
        action: "solve_cohesive_interface_1d",
        route: "/api/v1/fem/cohesive-interface-1d/jobs",
    },
    DirectFemRoute {
        action: "solve_cohesive_interface_2d",
    ...
    DirectFemRoute {
        action: "solve_cohesive_interface_mesh_3d",
        route: "/api/v1/fem/cohesive-interface-mesh-3d/jobs",
    },
    DirectFemRoute {
    ...
    DirectFemRoute {
        action: "solve_buckling_beam_1d",
        route: "/api/v1/fem/buckling-beam-1d/jobs",
    },
    DirectFemRoute {
        action: "solve_buckling_frame_2d",
        route: "/api/v1/fem/buckling-frame-2d/jobs",
    },
    DirectFemRoute {
        action: "solve_frame_2d_p_delta",
...
mod tests {
    ...
    fn maps_core_fem_actions_to_routes() {
        ...
        assert_eq!(
            direct_fem_submit_route("solve_magnetostatic_plane_quad_2d"),
            Some("/api/v1/fem/magnetostatic-plane-quad-2d/jobs")
        );
    }
    ...
    fn maps_extended_fem_actions_to_routes() {
        ...
        assert_eq!(
            direct_fem_submit_route("solve_stokes_flow_plane_triangle_2d"),
            Some("/api/v1/fem/stokes-flow-plane-triangle-2d/jobs")
        );
        assert_eq!(
        ...
        assert_eq!(
            direct_fem_submit_route("solve_cohesive_interface_1d"),
            Some("/api/v1/fem/cohesive-interface-1d/jobs")
        );
        assert_eq!(
        ...
        assert_eq!(
            direct_fem_submit_route("solve_cohesive_interface_mesh_3d"),
